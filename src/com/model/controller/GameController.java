...
public class GameController {
	...
	public void descriptionCardDestination(CarteDestination carteClicked, Game game) {
		JOptionPane.showMessageDialog(  game.getGameFrame().getGameScreen().getGameManagerScreen().getGameMapPanel(),
                carteClicked.getDescription(), "Carte Destination", JOptionPane.INFORMATION_MESSAGE );
	}
}