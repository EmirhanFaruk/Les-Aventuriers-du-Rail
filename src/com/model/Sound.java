...
public class Sound {
    ...
    private ArrayList<URL> arrayMusic (String screen) {
        switch (screen) {
            case "MENU" : return soundURLMenu;
            case "INGAME" : return soundURLInGame;
            case "PAUSE" : return soundURLPause;
            case "END" : return soundURLEnd;
            default : return null;
        }
    }
    ...
    private String[] listMusic ( String screen) {
       switch (screen) {
            case "MENU" :  return soundsMenu;
           case "INGAME" : return soundsInGame;
           case "PAUSE" : return soundsPause;
           case "END" : return soundsEnd;
           default : return null;
       }
    }
