...
public class WeakBot implements BotAction{
    ...
    @Override
    public void takeGare() {

    }

    @Override
    public void takeMissionsCard() {
        ...
        switch (whatToDo){
            ...
            case(1):
                ...
                for(int z = 0; z<carteDestination.length;z++){
                    game.getListPlayer().get(round.getAction()).getDestinationsList().add(carteDestination[z]);
                }
            ...
            case(2):
                ...
                for(int i = 0; i< game.getVilles().length;i++){
                    ...
                    toSetDownWagon = game.getListPlayer().get(round.getAction()).mettreRoute(game.getRoutes().get(i));
            ...
            default :
                ...
                if(game.getVilles()[wichStation].getIsOccuped() == null && game.getListPlayer().get(round.getAction()).getNbrGare() < 0){
                    game.getVilles()[wichStation].setIsOccuped(game.getListPlayer().get(round.getAction()));
                }
                else{
                    play(game,carteManager,round);
                }
