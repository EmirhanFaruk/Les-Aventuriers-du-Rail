...
public interface BotAction {
     ...
     */
    boolean takeLoad(Game game);

    /**
     * Permet au bot de poser une gare sur le plateau de jeu.
     *
     * @param game Le jeu actuel dans lequel le bot évolue.
     * @param whichStation L'index de la station que le bot souhaite poser(seulement utilisé avec le WeakBot).
     * @return {@code true} si l'action est réussie, {@code false} sinon.
     */
    boolean useGare(Game game, int whichStation);
